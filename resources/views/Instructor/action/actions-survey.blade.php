                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light ">
                     ...
                     <section class="mx-auto "style="margin-top:-15px" id="section">
                            ...
                            @endif
                               ...
                               <div> 
                                <h4 class="mb-4" style="margin-top:-10px">Note: if you want to delete action and explaination just do an update and set the 
                                value to none thanks.</h4>
                                </div> 
                                <table class="table table-bordered "style="margin-top:-10px" id="laravel_crud">
                                   ...
                                   @foreach($result as $info)
                                    ...
                                    <tr id="">
                                        ...
                                        <a href="{{route('action.edit',$info->id)}}" id="edit-user" data-id="" class="btn btn-info mr-0">Edit</a>
