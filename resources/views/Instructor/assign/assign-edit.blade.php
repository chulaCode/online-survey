...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Assign student to course') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{route('assign.update',$result->id) }}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="number" value="{{ old('number') ?? $result->number}}" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="duration" value="{{ old('duration')?? $result->duration }}" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="workload" type="number"
                                 ...
                                 name="workload" value="{{ old('workload')?? $result->workload }}" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="activity" type="text"
                                 ...
                                 name="activity" value="{{ old('activity')?? $result->activities }}" 
