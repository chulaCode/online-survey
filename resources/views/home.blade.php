...
<div id="preloader"></div>
    <header class="navbar navbar-inverse navbar-fixed-top " role="banner">
        <div class="container">
            ...
            <span style="color:white">You are logged in</span>
                </div>
                </ul>
                <!--
                @if (Route::has('login'))
                <div class="top-right links">
                    @auth
                        <a  href="{{ url('/home') }}"><Select>SURVEY</Select></a>
                        <span class="text-white">Your now logged in</span>
                    @else
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content center centered">
                                    ...
                                    <br>
                                    <a class="btn btn-md animation bounce-in" href="#services">view courses</a>
                                </div>
                            </div>
                        </div>
                    </div>
     ...
     <section id="services" class="white">
        <div class="container">
                    <div class="center gap fade-down section-heading">
                        ...
                        <hr>
                        <p>click on any course to fill survey form for the course.</p>
                    </div>
	                    ...
	                    <div class="col-md-4">
	                        <div class="post">
	                            <div class="post-img-content">
	                                <img src="/uploads/{{$results->image}}"class="img-responsive" />
	                                <div class="overlay">
	                                    <a class="preview btn btn-outlined btn-primary" href="#"><i class="fa fa-link"></i></a>
	                                </div>
	                            </div>
	                            <div class="content">
	                                <h2 class="post-title">{{$results->ccode}}</h2>
									@foreach($value as $teacher)
	                                <div class=" text-capitalize">
	                                    <i class="fa fa-user "></i> Lecturer  -> <b>{{$teacher->name}}</b> 
	                                </div>
									@endforeach
	                                <div>
	                                ...
	                                <div class="read-more-wrapper">
	                                    <a href="{{ route('survey.index',$results->ccode) }}" class="btn btn-outlined btn-primary">Take survey</a>
	                                </div>
	                            </div>
	                        </div>
	                    </div>
